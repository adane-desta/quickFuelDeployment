// =====================================================
// PAYMENT PROCESSOR - MOCK IMPLEMENTATION
// =====================================================
// Simulates Telebirr/Chapa payment gateway
...
export function PaymentProcessor({
  ...
  const paymentMethods = [
    {
      ...
      name: 'Telebirr',
      icon: <Smartphone className="size-6 text-orange-600" />,
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      notifications.payment.failed(error);
      setProcessing(false);
    }
  };
        ...
        <div className="flex gap-3">
          ...
          <div className="text-sm text-amber-900">
            ...
            <p className="text-amber-800">
              ...
              In production, this would integrate with actual {selectedMethod} API.
            </p>
          </div>
        </div>
      </Card>
